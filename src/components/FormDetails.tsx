    ...
    <div className="h-full overflow-y-auto pb-20">
      <div className="p-6 md:px-12 md:py-12 max-w-4xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="mb-12 relative flex flex-col items-start pt-4">
          ...
          {form.id === 'rla' && (
            <div className="w-full flex bg-[#F5F5F7] p-1.5 rounded-2xl mb-10 border border-black/5 select-none shrink-0">
              <button
          ...
          {(form.id !== 'rla' || rlaTab === 'overview') ? (
            <>
              <div className="flex items-center gap-2 text-zinc-400 font-medium mb-3 font-sans w-full">
                <FileText className="w-4 h-4" />
                <span className="tracking-widest uppercase text-[10px] font-bold">Form / {form.acronym}</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-semibold text-black tracking-tight leading-[1.1] mb-5 font-display flex items-baseline gap-3 flex-wrap w-full">
                {form.title}
                <span className="text-2xl md:text-3xl font-bold text-black font-display">({form.acronym})</span>
              </h1>

              <p className="text-lg text-zinc-500 leading-relaxed font-semibold max-w-2xl">
                {form.summary}
              </p>
            </>
          ) : null}
        ...
        {(form.id !== 'rla' || rlaTab === 'overview') && (
          <div className="grid gap-8 border-t border-black/5 pt-10">
            ...
            <div className="bg-[#F5F5F7] rounded-3xl p-8 md:p-10 border border-transparent transition-colors hover:border-black/5">
              ...
              <p className="text-zinc-600 leading-relaxed text-lg font-semibold">
                {form.importance}
              </p>
            </div>
